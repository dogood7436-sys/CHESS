...
- COMPUTOR 난이도: `초급자`(무작위 수), `중급자`(1수 평가+약간의 흔들림), `상급자`(미니맥스 탐색)를 선택할 수 있습니다.
- 고급 체스 규칙: 캐슬링, 앙파상, 50수 규칙 무승부, 3회 반복 무승부를 지원하며 COMPUTOR도 합법수 목록에 포함된 캐슬링/앙파상을 사용할 수 있습니다.
- 포인트 규칙:
  - 폰: 잡을 때 1점 / 부활 비용 2점
